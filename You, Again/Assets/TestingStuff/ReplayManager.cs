...
public class ReplayManager : MonoBehaviour
{
    ...
    [HideInInspector] public List<List<InputFrame>> allRecordedSegments = new List<List<InputFrame>>();
    
    private List<InputFrame> currentSegment = new List<InputFrame>();
    [HideInInspector] public List<GameObject> clones = new List<GameObject>();
